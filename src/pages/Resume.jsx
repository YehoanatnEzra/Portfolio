        ...
        <section className="container">
          <article className="resume-paper" aria-label="Resume content">
              ...
              <ul>
                <li>
                  ...
                  {!showCourses ? (
                    ...
                    >
                      Key Courses (see more)
                    </span>
                  ) : (
                    <div className="courses">
                      <strong>Key Courses:</strong>
                      <ul className="sublist">
                        <li>Discrete Math (100)</li>
                        <li>Nand to Tetris (94)</li>
                        <li>Data Structures (95)</li>
                        <li>Databases (91)</li>
                        <li>Algorithms (88)</li>
                        <li>Control and Learning (89)</li>
                        <li>Cybersecurity (pass)</li>
                        <li>Machine Learning, Data Science &amp; Computer Vision 3D (in progress)</li>
                      </ul>
                      <span
                        className="see-less"
            ...
            <section className="resume-section">
              ...
              <ul>
                <li>Guided students through calculus concepts, enhancing their understanding and problem-solving skills.</li>
              </ul>
